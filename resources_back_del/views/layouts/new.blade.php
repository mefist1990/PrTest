...
<html lang="en" data-textdirection="ltr" class="loading">
  <head>
    ...
    <title>{{ config('app.name', 'Сайт Тестов') }}</title>
          ...
          <div id="navbar-mobile" class="collapse navbar-toggleable-sm">
            ...
            <ul class="nav navbar-nav float-xs-right">
              ...
              <li class="dropdown dropdown-user nav-item"><a href="#" data-toggle="dropdown" class="dropdown-toggle nav-link dropdown-user-link"><span class="avatar avatar-online"><img src="../../app-assets/images/portrait/small/avatar-s-1.png" alt="avatar"><i></i></span><span class="user-name">{{ Auth::user()->name }}</span></a>
                <div class="dropdown-menu dropdown-menu-right"><a href="#" class="dropdown-item"><i class="icon-head"></i> Редактировать профиль</a><a href="{{ route('login') }}" class="dropdown-item"><i class="icon-mail6"></i>Зайти</a><a href="#" class="dropdown-item"><i class="icon-clipboard2"></i> Задачи</a><a href="/admin/" class="dropdown-item"><i class="icon-calendar5"></i> Админ. панель</a>
