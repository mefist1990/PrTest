...
class HomeController extends Controller
{
    ...
    {
        $html = file_get_contents('http://talentfinder.ru/primer2.html');
    ...
    public function pdftesttwo()
    {
        $output = system('/usr/local/bin/wkhtmltopdf  /home/test/test/public/primer2.html /home/test/test/public/pdf/primer2.pdf', $retval);
        //$output = shell_exec('wkhtmltopdf  /home/test/test/public/primer2.html /home/test/test/public/pdf/primer2.pdf');
        echo $retval;
    }
    public function index()
    {
        ...
        if ($counter == 1) {
            ...
            // dd($issues);
            $issues_all = Issues::all();
            return view('home', compact('issues', 'issues_result', 'counter'));
        }
    ...
    public function test(Request $request)
    {
        ...
        $user_diarytests_save = DiaryTests::where([
            [ 'user_id', '=', $user_id ],
            [ 'issues_id', '=', $issues_id ],
        ])->get();
        if (empty($user_diarytests_save)) {
    ...
    public function back(Request $request)
    {
        ...
        $issues = Issues::find($issues_id);
        $counter = $counter-1;
        return view('back', compact('issues', 'issues_result', 'counter' ));
    }
    ...
    public function reset()
    {
        ...
        if (!empty($user_results))
        {
            foreach ($user_results as $user_result)
            {
                ...
                if (!empty(DiaryTests::find($user_result_id)))
                {
